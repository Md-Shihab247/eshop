...
const LeftArrow = ({click}) => {
  return ( 
    <svg className={` absolute top-[50%] cursor-pointer left-[-50px] -translate-y-[50%]`} onClick={click} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

...
const RightArrow = ({click}) => {
  return (
    <svg className={` absolute cursor-pointer top-[50%] right-[-50px] -translate-y-[50%]`}  onClick={click} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

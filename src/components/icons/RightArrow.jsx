...
const RightArrow = ({click,springArrow,width,height ,bg}) => {
  return (
    <svg style={{width: width || "40px", height: height || "40px", background: bg || "transparent"}} className={` rounded-[50%] absolute cursor-pointer top-[50%] ${springArrow ? 'right-[-36px]' : 'right-[-45px]'} -translate-y-[50%]`}  onClick={click} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

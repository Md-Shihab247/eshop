...
const AccordionIcon = ({toggle,active,}) => {
  return (
    <svg onClick={toggle} className={` ${active && 'rotate-90'} cursor-pointer duration-300 outline outline-offset-[-2px] outline-[#FF624C] rounded-[50%] h-[24px] sm:h-[31px] w-[24] sm:w-[31px]`} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">

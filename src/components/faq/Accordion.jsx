...
const Accordion = ({question,answer,isOpen,activeToggle}) => {
  ...
  return (
    <button onClick={activeToggle}  className={` transition-all cursor-pointer duration-300 w-full flex justify-start gap-x-2 sm:gap-x-8 bg-white rounded-[15px] sm:rounded-[25px] py-4 sm:py-[33px] px-2 sm:pl-12 sm:pr-[56px] mb-3 sm:mb-6 last:mb-0`} >

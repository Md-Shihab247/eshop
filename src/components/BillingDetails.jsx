        ...
        <h2 className=' font-poppins text-[36px] font-semibold leading-[46px] text-[#303030]'>Billing Details</h2>
            ...
            <div className=' mt-10'>
              <div className=' w-full [&>div:not(:last-child)]:mb-8'>
                ...
                <div className='flex gap-x-4'>
                  <div className='w-[50%]'>
                    <InputBox isStar={true} textArea={false} type={"text"} inputType={"Country"} placeholder={"Indonesia"}/>
                  </div>
                  <div className='w-[50%]'>
                    <InputBox isStar={true} textArea={false} type={"text"} inputType={"State"} placeholder={"Kalimantan Timur"}/>
                  </div>
                </div>
                <div className='flex gap-x-4'>
                  <div className='w-[50%]'>
                    <InputBox isStar={true} textArea={false} type={"text"} inputType={"City"} placeholder={"Samarinda"}/>
                  </div>
                  <div className='w-[50%]'>
